...
public class VXGIRenderer : System.IDisposable
{
    ...
    {
        get { return _renderPipeline.perObjectData; }
    }
    ...
    void RenderGBuffers(ScriptableRenderContext renderContext, Camera camera)
    {
        ...
        var drawSettings = new DrawingSettings(new ShaderTagId("Deferred"), new SortingSettings(camera));


        drawSettings.perObjectData = _renderPipeline.perObjectData;
